...
const filterConfig = [
  {
    ...
    icon: Sparkles,
    activeClass:
      "bg-emerald-500/10 border-emerald-400/60 text-emerald-600 dark:text-emerald-400",
    inactiveClass:
  ...
  },
  {
    ...
    icon: Wifi,
    activeClass:
      "bg-blue-500/10 border-blue-400/60 text-blue-600 dark:text-blue-400",
    inactiveClass:
      "bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 text-gray-600 dark:text-gray-400",
  },
  {
    ...
    icon: DollarSign,
    activeClass:
      "bg-amber-500/10 border-amber-400/60 text-amber-600 dark:text-amber-400",
    inactiveClass:
      "bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 text-gray-600 dark:text-gray-400",
  },
];
...
export default function FilterBar({ filters, onChange }) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-2.5 justify-center">
      ...
      {filterConfig.map(
        ({ key, label, icon: Icon, activeClass, inactiveClass }) => (
          <button
            key={key}
            onClick={() => toggle(key)}
