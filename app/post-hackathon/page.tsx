  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 transition-colors duration-300">
      ...
      <main className="max-w-2xl mx-auto px-4 py-24 sm:px-6 lg:px-8">
        <div className="mb-6">
          <Link href="/#hackathons" className="inline-flex items-center gap-2 text-sm text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white transition-colors">
            <ArrowLeft size={16} />
            Back to Hackathons
          </Link>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800/80 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700/60 p-6 sm:p-8">
          <div className="mb-8">
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Post a Hackathon</h1>
            <p className="text-sm text-gray-500 dark:text-gray-400">Share a new hackathon opportunity with the community.</p>
          </div>
          ...
          {success ? (
            <div className="rounded-xl border border-green-200 bg-green-50 px-4 py-8 text-center text-green-700 dark:border-green-800/60 dark:bg-green-950/20 dark:text-green-300">
              ...
              <p className="text-sm opacity-90">Redirecting you back to the hackathons...</p>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <label htmlFor="title" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Hackathon Title</label>
                <input
                  type="text"
                  id="title"
                  name="title"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label htmlFor="college" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">College / Organization</label>
                  <input
                    type="text"
                    id="college"
                    name="college"
                ...
                <div>
                  <label htmlFor="date" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Date (Deadline)</label>
                  <input
                    type="date"
                    id="date"
                    name="date"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label htmlFor="mode" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Mode</label>
                  <select
                    id="mode"
                    name="mode"
                    value={formData.mode}
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 px-4 py-2 text-gray-900 dark:text-white focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
                    placeholder={formData.mode === 'online' ? "e.g. Global" : "e.g. Cambridge, MA"}
                  />
                </div>
              </div>

              <div>
                <label htmlFor="registration_link" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Registration Link</label>
                <input
                  type="url"
